 ...
 */
class CRM_Secretdata_Upgrader_Base {

  /**
   * @var CRM_Secretdata_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Secretdata_Upgrader(
        'de.systopia.secretdata',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Secretdata_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Secretdata_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
